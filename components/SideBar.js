			...
			<div className="trm-main-card-frame trm-sidebar">
				...
				>
					...
					<div className="trm-mc-header">
						...
						<h5 className="trm-name trm-mb-10">Lindsey Howard </h5>
					...
					<div className="trm-social">
						<a
							href="https://linkedin.com/in/Lindsey Howard-howard"
							target="_blank"
						>
							<i className="fab fa-linkedin-in" />
						</a>
						<a href="https://medium.com/@Lindsey Howardkdev" target="_blank">
							<i className="fab fa-medium" />
						</a>
						<a href="https://github.com/codelikeagirl29" target="_blank">
							<i className="fab fa-github" />
						</a>
						<a href="https://dribbble.com/codelikeagirl29" target="_blank">
					...
					<ul className="trm-table trm-mb-20">
						...
						<li>
							...
							<div className="trm-label trm-label-light">Florida</div>
						</li>
						{/* city */}
						<li>
							<div className="trm-label">City:</div>
							<div className="trm-label trm-label-light">Fort Walton Beach</div>
						</li>
						{/* age */}
						<li>
							<div className="trm-label">Age:</div>
							<div className="trm-label trm-label-light">33</div>
						</li>
					</ul>
					{/* info end */}
					<div className="trm-divider trm-mb-20 trm-mt-20" />
